class Solution {
    public long countCommas(long n) {
        ...
        // agar n 1000 se bada hua toh 1000 se lekar n tak jitne commas aayenge vo sab add honge
        if (n >= 1000) {
            commas += n - 999;
        }

        // agar n 1000000 se bada hua toh 1000000 se lekar n tak jitne extra commas aayenge vo sab add honge
        if (n >= 1000000) {
            commas += n - 999999;
        }

        // agar n 1000000000 se bada hua toh 1000000000 se lekar n tak jitne extra commas aayenge vo sab add honge
        if (n >= 1000000000L) {
            commas += n - 999999999;
        }

        // agar n 1000000000000 se bada hua toh 1000000000000 se lekar n tak jitne extra commas aayenge vo sab add honge
        if (n >= 1000000000000L) {
            commas += n - 999999999999L;
        }

        // agar n 1000000000000000 se bada hua toh 1000000000000000 se lekar n tak jitne extra commas aayenge vo sab add honge
